...
import datetime
import pandas as pd
from utils.data_ingestion_utils import perform_get_request, xml_to_load_dataframe, xml_to_gen_data
from report import report_data_ingestion
...
def main(start_time, end_time, output_path):
    ...
    report_data_ingestion(output_path, list(regions.keys()))
